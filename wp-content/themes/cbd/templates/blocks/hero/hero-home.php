    ...
    <div class="animations absolute top-0 left-0 w-full h-full z-10">
        <?php if ($img_day_2 || $img_night_2) : ?>
            <!-- <div class="moon absolute w-44" data-scroll>
                ...
                <?php endif; ?>
                <?php if ($img_night_2) : ?>
                    <img class="imgs-night" src="<?php echo $img_night_2; ?>"
        ...
        <?php if ($lottie_day) : ?>
            ...
            <dotlottie-player autoplay controls loop mode="normal" src="<?php echo get_template_directory_uri() . '/animation/dragon.lottie'; ?>"></dotlottie-player>
        ...
        <?php if ($lottie_night) : ?>
            ...
            <dotlottie-player autoplay controls loop mode="normal" src="<?php echo get_template_directory_uri() . '/animation/dragon.lottie'; ?>" style="width: 320px;height:320px;"></dotlottie-player>
        <?php endif; ?>
        <!--
        <?php if ($lottie_day_2) : ?>
            <lottie-player src="<?php echo $lottie_day_2; ?>" class="horse imgs-day" background="transparent" speed="1"
