...
// function getStringAfterSlash($input)
// {
//     $parts = explode('/', $input);
...
//     if ($block['blockName']) {
//         $acf_name = getStringAfterSlash($block['blockName']);
//         global ${$acf_name . '_acf_data'};
//         ${$acf_name . '_acf_data'} = $block['attrs']['data'];  // ACF block data
//     }
// }
?>
<!doctype html>
