        ...
        <div class="flex justify-center">
            <div class="w-full">
                <div class="leaderboard-frame font-headers bg-black pb-12 relative rounded-[50px] mb-[-100px]">
                    ...
                    <?php endif; ?>
                    <div class="flex flex-col gap-[30px] p-[30px] lg:p-[20px_65px] relative z-[10]">
                        <div class="flex justify-between items-center text-[16px] sm:text-[18px] lg:text-[20px] wadik text-white gap-[15px] md:gap-[25px]">
                            <h4 class="min-w-[60px]">1ST</h4>
                        ...
                        <div class="flex justify-between items-center text-[16px] sm:text-[18px] lg:text-[20px] wadik text-white gap-[15px] md:gap-[25px]">
                            <h4 class="min-w-[60px]">3RD</h4>
                            <h4 class="flex items-center gap-[15px] pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                            <h4 class="flex items-center gap-[15px] hidden sm:block pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                            <h4 class="flex items-center gap-[15px] hidden sm:block pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                        </div>
                        <div class="flex justify-between items-center text-[16px] sm:text-[18px] lg:text-[20px] wadik text-white gap-[15px] md:gap-[25px]">
                            <h4 class="min-w-[60px]">4th</h4>
                            <h4 class="flex items-center gap-[15px] pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                            <h4 class="flex items-center gap-[15px] hidden sm:block pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                            <h4 class="flex items-center gap-[15px] hidden sm:block pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                        </div>
                        <div class="flex justify-between items-center text-[16px] sm:text-[18px] lg:text-[20px] wadik text-white gap-[15px] md:gap-[25px]">
                            <h4 class="min-w-[60px]">5th</h4>
                            <h4 class="flex items-center gap-[15px] pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                            <h4 class="flex items-center gap-[15px] hidden sm:block pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                            <h4 class="flex items-center gap-[15px] hidden sm:block pl-[30px] relative"><img class="absolute left-0 top-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/userIcon.svg" alt="torch"> Long Name</h4>
                        </div>
