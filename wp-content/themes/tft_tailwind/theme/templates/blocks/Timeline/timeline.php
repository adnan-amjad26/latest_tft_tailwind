    ...
    <div class="flex flex-col relative">
        <div class="absolute bottom-[30%] left-0 right-0 overflow-x-auto hide-scrollbar flex flex-col justify-end h-full z-[99]">
            ...
            <ul class="pl-[150px] 2xl:px-0 2xl:w-[80%] min-w-[1400px] 2xl:min-w-[1490px] mx-auto flex justify-start 2xl:justify-between gap-[70px] lg:gap-[6%] whitespace-nowrap pt-[8%]">
                <li class="2xl:w-full timeline-content-link relative">
                    ...
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                        </div>
                        <img class="w-full relative top-[-60%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-content-bg.png" alt="">
                    </div>
                </li>
                <li class="2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-55%] xl:top-[-32%] 2xl:top-[-41%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-42%] xl:top-[-37%] 2xl:top-[-28%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-27%] xl:top-[-28%] 2xl:top-[-31%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-29%] xl:top-[-40%] 2xl:top-[-45%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-33%] xl:top-[-57%] 2xl:top-[-60%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-50%] xl:top-[-68%] 2xl:top-[-74%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-62%] lg:top-[-70%] 2xl:top-[-72%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-73%] xl:top-[-61%] 2xl:top-[-65%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-70%] xl:top-[-44%] 2xl:top-[-49%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
                ...
                <li class="inline-block 2xl:w-full timeline-content-link relative">
                    <img class="w-full relative top-[-55%] xl:top-[-64%] 2xl:top-[-32%]" src="<?php echo get_template_directory_uri(); ?>/img/timeline-tag.svg" alt="">
                    <div class="timeline-content w-[439px] absolute left-1/2 -translate-x-1/2 bottom-[100%] opacity-0 pointer-events-none">
                        <div class="absolute left-0 right-0 top-0 bottom-0 z-[2] whitespace-normal p-[50px_88px] text-center text-[#181818]">
                            <h4 class="max-w-[128px] mx-auto text-[18px] wadik pt-[40px] mb-[18px]">May 21st, 2021</h4>
                            <p class="max-w-[257px] w-full mx-auto text-[18px] font-medium">The Funded Trader was Founded by Angelo Ciaramello, Blake Olson and Carlos Rico Jr. The founders set out to disrupt the entire industry by offering top notch support, customer centric challenges, and an interactive trading community.</p>
