...
<?php $language_menu = wp_get_nav_menu_object($menus['language']);
?>
...
$dark_bg = $dark_bg ? get_main_dark_bg($dark_bg) : '';
...
<div class="z-40" data-scroll-container>
	<main class="relative <?php echo $bg . ' ' . $dark_bg; ?>">
