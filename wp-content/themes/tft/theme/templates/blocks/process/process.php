...
<section class="bricks-elem content-scrolls no-transparent py-[115px] relative z-[100] px-[16px] md:px-[40px] 2xl:px-[85px]" data-scroll-section>
        ...
        <?php if($process): ?>
            ...
            <?php $i = 1; foreach($process as $type): ?>
                ...
                <?php if($phases):?>
                    ...
                    <div class="steps flex flexx lg:hidden gap-[16px] items-center justify-center mt-[25px]">
