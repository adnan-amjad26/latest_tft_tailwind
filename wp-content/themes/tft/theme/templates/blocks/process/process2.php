...
<div class="bricks-elem w-full custom-gradient pt-[50px] pb-[150px] dark:lg:pb-[0] lg:pb-[400px] px-[16px] md:px-[40px] 2xl:px-[85px] dark:relative dark:z-[20]">
    <div class="max-w-[1750px] w-full mx-auto relative z-[2]">
        <!-- Box -->
                        ...
                        <div class="w-full lg:w-1/3 max-w-[400px] lg:max-w-[495px] mx-auto">
                            <div class="w-full flex flex-col gap-[10px] items-center mb-[25px]">
                                <div class="w-[70px] 2xl:w-[85px] h-[70px] 2xl:h-[85px] mx-auto rounded-full relative flex items-center justify-center">
                                    ...
                                    <img class="absolute left-0 right-0 top-0 bottom-0 z-[2]" decoding="async" loading="lazy"
