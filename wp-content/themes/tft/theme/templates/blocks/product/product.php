                    ...
                    <?php if($account_type): ?>
                        <ul class="toggles w-full second flex gap-6 lg:gap-12 justify-center font-headers text-[15px] mt-12 lg:mt-16">
                            <?php foreach($account_type as $attr): ?>
                                <?php $image = get_field('image', $attr); ?>
                                <li class="w-full md:w-auto md:min-w-[243px] text-center wadik text-[14px] lg:text-[15px]" <?php if($image['url']) echo ' style="background-image: url('.$image['url'].');"'; ?> account_type="<?php echo $attr->slug; ?>">
                                    <span><?php echo $attr->name; ?></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    ...
                    <?php if($account_size): ?>
                        <ul class="payment-list toggles w-full third block whitespace-nowrap overflow-auto font-headers text-[16px] mt-12 lg:mt-16 text-center">
                            <?php foreach($account_size as $attr): ?>
                                <li class="inline-block mx-[4px] min-w-[85px] lg:min-w-[165px] wadik text-[12px] lg:text-[16px]" account_size="<?php echo $attr->slug; ?>">
                                    <span><?php echo $attr->name; ?></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                            ...
                            <?php if($variation_id): ?>
                                ...
                                <div class="flex justify-center">
                                    <div class="button mt-12 lg:mt-24 mx-auto">
                                        <a href="<?php echo $_product->add_to_cart_url(); ?>" class="btn btn-gold p-[.8rem_2rem_.7rem] rounded-[1rem] border-[.5rem] border-[#f7971e] border-t-[#f2af5d] border-b-[#c86e32] relative inline-flex items-center wadik text-[1.2rem]">
