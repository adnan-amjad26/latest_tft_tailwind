...
<figure class="bricks-elem tower dark:relative dark:z-[9] absolute top-0 left-0 w-full z-0 bricks-elem pointer-events-none dark:top-[-165px]">
...
<section<?php if($id) echo ' id="'.$id.'"'; ?> class="table-tabs bricks-elem relative z-[2] dark:z-[100]">
	<div class="max-w-[1750px] w-full mx-auto pt-[100px] dark:pt-0 px-[16px] md:px-[40px] 2xl:px-[85px]">
		<?php if($title): ?>
            <div class="flex">
                <div class="w-full text-center">
                    <div class="title relative dark:mt-[-225px]">
                        ...
                        <div class="absolute left-1/2 top-[-155px] -translate-x-1/2">
