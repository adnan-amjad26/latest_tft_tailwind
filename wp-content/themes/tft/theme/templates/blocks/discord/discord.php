...
<section class="discord text-center bg-lilac pt-0 lg:pt-[300px] relative z-[1]" data-scroll-section>
        ...
        <div class="flex flex-col items-center px-[16px] md:px-[40px]">
            ...
            <?php if($image || $link || $lottie): ?>
                ...
                <?php if($lottie): ?>
                    ...
                    <div class="mockup-shadow blur-[100px] bg-[#F7971E] absolute top-[50px] xl:top-auto xl:bottom-[50px] left-0 xl:left-[-300px] right-0 xl:right-[-300px] h-[200px] lg:h-[450px] rounded-[500px_500px_0_0] z-[-1] opacity-[0.8] pointer-events-none"></div>
                   <div class="w-full flex flex-col gap-[0] mb-[-350px] relative z-[20]">
                   <?php if($image): ?>
                        <figure class="mockup">
    ...
    <?php if($background): ?>
        <figure class="bg absolute bottom-0 left-0 w-full z-0">
            <img class="h-[600px]" decoding="async" loading="lazy" src="<?php echo $background['url']; ?>" alt="<?php echo $background['title']; ?>">
        </figure>
    <?php endif; ?>
</section>
