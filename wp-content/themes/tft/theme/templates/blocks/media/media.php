...
<section class="media-boxes p-[100px_16px] dark:!pt-[0] md:p-[150px_40px] !pb-[100px] lg:!pb-[200px] dark:!pb-[50px] text-center bg-[#5e113b] relative z-[2] after:z-[2] after:content-[''] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-[350px] after:bg-gradient-to-t dark:after:from-[#4e1e4d] after:pointer-events-none dark:min-h-[auto] min-h-[1500px]" data-scroll-section>
