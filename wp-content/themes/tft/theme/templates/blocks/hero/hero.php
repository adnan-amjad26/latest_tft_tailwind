...
<section class="title-bar<?php echo $class.$bg.$overflow; ?> z-10" data-scroll-section>
    <div class="max-w-[1750px] w-[calc(100%_-_50px)] md:w-[calc(100%_-_100px)] mx-auto z-[99] absolute left-0 right-0 top-[250px]">
	    ...
	    <figure class="bg w-full z-0 pointer-events-none relative <?php echo $after; ?>">
			<?php if($image || $img_d_1 || $img_d_2): ?>
				<div class="imgs-day">
					<?php if($img_d_1): ?>
						<div class="overlay">
							<img class="h-[1000px] md:h-[800px] lg:h-auto object-center-top" src="<?php echo $img_d_1['url']; ?>" alt="<?php echo $img_d_1['title']; ?>">
						</div>
					<?php endif; ?>
					<?php if($lottie): ?>
						<div class="tower">
							<img class="h-[1000px] md:h-[800px] lg:h-auto object-center-top" src="<?php echo $lottie['url']; ?>" alt="<?php echo $lottie['title']; ?>">
						</div>
					<?php endif; ?>
					<?php if($image): ?>
						<img class="h-[1000px] md:h-[800px] lg:h-auto object-center-top" src="<?php echo $image['url']; ?>" alt="<?php echo $image['title']; ?>">
					<?php endif; ?>
					<?php if($img_d_2): ?>
						<div class="underlay">
				...
				<div class="imgs-night">
					<?php if($img_n_1): ?>
						<div class="moon absolute w-52" data-scroll>
							<img class="h-[1000px] md:h-[800px] lg:h-auto object-center-top" src="<?php echo $img_n_1['url']; ?>" alt="<?php echo $img_n_1['title']; ?>">
						</div>
					<?php endif; ?>
					<?php if($img_n_2): ?>
						<img  class="h-[1000px] md:h-[800px] lg:h-auto object-center-top" src="<?php echo $img_n_2['url']; ?>" alt="<?php echo $img_n_2['title']; ?>">
					<?php endif; ?>
					<?php if($image_2): ?>
						<img  class="h-[1000px] md:h-[800px] lg:h-auto object-center-top" src="<?php echo $image_2['url']; ?>" alt="<?php echo $image_2['title']; ?>">
