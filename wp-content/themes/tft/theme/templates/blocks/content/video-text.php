...
<section<?php if($id) echo ' id="'.$id.'"'; ?> class="video-text-content py-[60px] px-[16px] 2xl:px-[85px] content-image overflow-visible<?php echo $bg; ?> <?php echo $padding; ?> z-10" data-scroll-section>
    <div class="max-w-[1750px] w-full mx-auto py-[50px] relative z-[10]">
        <div class="text-video-content flex flex-col-reverse xl:flex-row gap-[100px] sm:gap-[100px] lg:gap-[50px] xl:pr-[50px] justify-between items-center <?php if($reverse) echo ' xl:flex-row-reverse even-reverse'; ?>">
            ...
            <div class="max-w-[720px] xl:max-w-full w-full xl:w-1/2 relative row items-center">
                <div class="w-full flex items-center gap-[50px] xl:gap-[100px] xl:pl-[50px]">
                    <div class="table-tabs relative hidden xl:block">
                    ...
                    <div class="inner flex-1 z-10">
                        <?php if($title): ?>
                            <div class="title mb-[45px] sm:max-w-[358px] xl:max-w-full sm:mx-auto">
                                <h2 class="text-[36px] sm:text-[36px] text-center xl:text-left xl:text-[30px] xl:text-[40px] 2xl:text-[50px]"><?php echo $title; ?></h2>
                            </div>
                        <?php endif; ?>
                        <?php if($text): ?>
                            <div class="content text-[15px] sm:text-[15px] lg:text-[16px] text-center xl:text-left max-w-[358px] md:max-w-full mx-auto">
                                <?php echo $text; ?>
                            </div>
                        <?php endif; ?>
                        <?php if($link): ?>
                            <div class="button mt-16 lg:mt-16 text-center xl:text-left">
