...
function get_main_dark_bg($prefix)
{
	$classes = '';

	switch ($prefix) {
		case 'indigo':
			$classes = 'dark:bg-[rgb(31,30,44)]';
			break;
		case 'indigo-dark':
				$classes = 'dark:bg-[rgb(26,25,38)]';
			break;
		case 'navy':
			$classes = 'dark:bg-[rgb(0,0,50)]';
			break;
		case 'lilac':
			$classes = 'dark:bg-[rgb(83,13,54)]';
			break;
		case 'lilac-dark':
			$classes = 'dark:bg-[rgb(41,16,73)]';
			break;
	}
