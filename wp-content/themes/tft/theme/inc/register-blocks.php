...
function register_acf_block_types() {
    ...
    acf_register_block_type(array(
	  ...
	  acf_register_block_type(array(
        'name'              => 'mediapage',
        'title'             => __('Media Page'),
        'render_template'   => 'templates/blocks/mediapage/mediapage.php',
        'category'          => 'custom-blocks',
        'icon'              => 'video-alt3',
        'mode'              => 'edit',
    ));
	...
	acf_register_block_type(array(
		'name'              => 'blogpage',
		'title'             => __('Blog Page'),
		'render_template'   => 'templates/blocks/blogpage/blogpage.php',
		'category'          => 'custom-blocks',
		'icon'              => 'book',
		'mode'              => 'edit',
	));
    ...
    acf_register_block_type(array(
        'name'              => 'process 2',
        'title'             => __('Process 2'),
        'render_template'   => 'templates/blocks/process/process2.php',
        'category'          => 'custom-blocks',
        'icon'              => 'admin-generic',
        'mode'              => 'edit',
    ));
    ...
    acf_register_block_type(array(
        'name'              => 'whychoose-table',
        'title'             => __('Why Choose TheFunded Trader'),
        'render_template'   => 'templates/blocks/whychoose/whychoose.php',
        'category'          => 'custom-blocks',
        'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
        'mode'              => 'edit',
    ));
	...
	acf_register_block_type(array(
		'name'              => 'privacy-hero',
		'title'             => __('Privacy Policy Hero'),
		'render_template'   => 'templates/blocks/privacy-policy/hero.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));
	...
	acf_register_block_type(array(
		'name'              => 'refund-hero',
		'title'             => __('Refund Policy Hero'),
		'render_template'   => 'templates/blocks/refund-policy/hero.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));

//	Funcding Process Challenge Details Tabs

	acf_register_block_type(array(
		'name'              => 'challenge-blocks',
		'title'             => __('Funding Process Challenge Tabs'),
		'render_template'   => 'templates/blocks/challenge/challenge_blocks.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));
	...
	acf_register_block_type(array(
		'name'              => 'team-card',
		'title'             => __('Team Element'),
		'render_template'   => 'templates/blocks/team/new-team.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));
	...
	acf_register_block_type(array(
		'name'              => 'Action-Point',
		'title'             => __('Action Point Element'),
		'render_template'   => 'templates/blocks/action-point/action-point.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));
	...
	acf_register_block_type(array(
		'name'              => 'Our-Mission',
		'title'             => __('Our Mission Element'),
		'render_template'   => 'templates/blocks/our-mission/our-mission.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));
	...
	acf_register_block_type(array(
		'name'              => 'challenge-type',
		'title'             => __('Chalenge Type Blocks'),
		'render_template'   => 'templates/blocks/challenge/challenge_type.php',
		'category'          => 'custom-blocks',
		'icon'              => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false"><path d="M3 18h8V6H3v12zM14 7.5V9h7V7.5h-7zm0 5.3h7v-1.5h-7v1.5zm0 3.7h7V15h-7v1.5z"></path></svg>',
		'mode'              => 'edit',
	));
