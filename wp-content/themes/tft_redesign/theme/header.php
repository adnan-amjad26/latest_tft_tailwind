...
<?php $bg = get_field('bg'); ?>
<?php $bg = ($bg) ? $bg : 'bg-red'; if(is_singular('post')) $bg = 'bg-lilac-dark'; ?>
<header class="fixed z-50 top-0 left-0 w-full text-white">
	<div class="max-w-[1755px] relative z-10">
						...
						<div class="buttons-setup flex items-center">
							...
							<?php if($audio): ?>
								<div class="music-controls">
									<img decoding="async" src="<?php echo get_template_directory_uri(); ?>/img/lute.svg" alt="lute">
									<audio loop>
