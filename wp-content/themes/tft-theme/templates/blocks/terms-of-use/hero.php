...
<section class="relative overflow-hidden pt-[60px] pb-[400px] mb-[-400px] md:pt-0 md:pb-[250px] md:mb-[-250px]">
	<div class="dark:hidden">
		...
		<div class="absolute w-full left-0 z-30 bottom-[-150px] h-[500px] bg-[linear-gradient(180deg,_rgba(55,11,35,0.00)_0%,_rgba(87,17,20,0.00)_0.01%,_#571114_42.01%)]"></div>
	</div>
	...
	<div class="hidden dark:block">
		...
		<div class="absolute w-full left-0 z-30 bottom-[-150px] h-[500px] bg-[linear-gradient(180deg,_rgba(55,11,35,0.00)_0%,_rgba(0,0,50,0.00)_0.01%,_#000032_42.01%)]"></div>
	</div>
