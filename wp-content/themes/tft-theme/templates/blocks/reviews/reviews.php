...
?>
<section class="testimonials p-[150px_40px] text-center z-10<?php echo $bg; ?>" data-scroll-section>
							...
							<?php foreach($reviews as $review): ?>
								...
								<?php if($rating >= 4): ?>
									...
									<div class="swiper-slide bg-black rounded-[20px] p-[3rem] flex flex-col justify-between review-container min-h-[400px]">
										...
										<img class="w-[108.7%] top-0 left-1/2 -translate-x-1/2 -translate-y-[60%]" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/testimonials-top.svg" alt="testimonials-top">
										<img class="w-[108.7%] bottom-[-30px] left-1/2 -translate-x-[50%]" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/testimonials-bottom.svg" alt="testimonials-bottom">
