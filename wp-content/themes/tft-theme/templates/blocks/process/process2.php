            ...
            <div class="w-full">
                <div class="flex flex-col lg:flex-row gap-[80px] lg:gap-[30px] xl:gap-[50px] 2xl:gap-[80px] text-center mt-12 lg:mt-16 scrolls justify-center">
                        ...
                        <div class="w-full lg:w-1/3 max-w-[400px] lg:max-w-[495px] mx-auto">
                            <div class="w-full flex flex-col gap-[10px] items-center mb-[25px]">
                                <div class="w-[70px] 2xl:w-[85px] h-[70px] 2xl:h-[85px] mx-auto rounded-full relative flex items-center justify-center">
                                    <h6 class="text-[#F7971E] text-[26px] 2xl:text-[32px] relative z-[20]">1</h6>
                                    <img class="absolute left-0 right-0 top-0 bottom-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/number-shape.svg" alt="scroll-content">
                                </div>
                                <h4 class="text-[18px] 2xl:text-[20px] text-white pointer-events-none">The Challenge</h4>
                            </div>
                            <div class="inner">
                                <div class="title font-headers text-black relative z-[2]">
                                    <h4 class="relative z-[1]">Phase 1</h4>
                        ...
                        <div class="w-full lg:w-1/3 max-w-[400px] lg:max-w-[495px] mx-auto">
                            <div class="w-full flex flex-col gap-[10px] items-center mb-[25px]">
                                <div class="w-[70px] 2xl:w-[85px] h-[70px] 2xl:h-[85px] mx-auto rounded-full relative flex items-center justify-center">
                                    <h6 class="text-[#F7971E] text-[26px] 2xl:text-[32px] relative z-[20]">2</h6>
                                    <img class="absolute left-0 right-0 top-0 bottom-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/number-shape.svg" alt="scroll-content">
                                </div>
                                <h4 class="text-[18px] 2xl:text-[20px] text-white pointer-events-none">The Verification</h4>
                            </div>
                            <div class="inner">
                                <div class="title font-headers text-black relative z-[2]">
                                    <h4 class="relative z-[1]">Phase 2</h4>
                                    <img class="w-full left-[50%] top-[50%] absolute -translate-x-1/2 -translate-y-1/2 z-[0]" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/scroll-title.svg" alt="scroll-title">
                                </div>
                        ...
                        <div class="w-full lg:w-1/3 max-w-[400px] lg:max-w-[495px] mx-auto">
                            <div class="w-full flex flex-col gap-[10px] items-center mb-[25px]">
                                <div class="w-[70px] 2xl:w-[85px] h-[70px] 2xl:h-[85px] mx-auto rounded-full relative flex items-center justify-center">
                                    <h6 class="text-[#F7971E] text-[26px] 2xl:text-[32px] relative z-[20]">3</h6>
                                    <img class="absolute left-0 right-0 top-0 bottom-0" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/number-shape.svg" alt="scroll-content">
                                </div>
                                <h4 class="text-[18px] 2xl:text-[20px] text-white pointer-events-none">The funded trader</h4>
                            </div>
                            <div class="inner">
                                <div class="title font-headers text-black relative z-[2]">
                                    <h4 class="relative z-[1]">Phase 3</h4>
                                    <img class="w-full left-[50%] top-[50%] absolute -translate-x-1/2 -translate-y-1/2 z-[0]" decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/scroll-title.svg" alt="scroll-title">
                                </div>
