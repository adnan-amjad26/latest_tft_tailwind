    ...
    <div class="max-w-[1308px] w-full mx-auto relative z-10">
        ...
        <div class="flex mt-12 lg:mt-16">
            ...
            <?php $faq_right = array_slice($faq, $half); ?>
                <div class="flex flex-col sm:flex-row lg:hidden items-center gap-[20px]">
                    <button class="toggle-button w-full lg:w-auto" id="button1" data-target="div1">Show Div 1</button>
                    <button class="toggle-button w-full lg:w-auto" id="button2" data-target="div2">Show Div 2</button>
                </div>
                ...
                <div class="flex flex-col lg:flex-row items-center gap-[70px]">
                    ...
                    <div class="w-full  hidden lg:block"  id="div2">
                        <?php if ($faq_right): ?>
                            <ul class="w-full items text-white bg-black text-[14px] p-[0_15px_15px_15px] flex flex-col bg-opacity-[0.7]">
