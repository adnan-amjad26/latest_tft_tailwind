...
function cbd_setup()
{
	...
	register_taxonomy('media_video_category', ['media_video'], [
		'label'                 => 'media_video_category',
		'labels'                => [
			'name'              => 'Video category',
			'singular_name'     => 'Video ategories',
			...
			'back_to_items'     => '← Back to video categories',
		],
		'description'           => 'Categories for media page videos',
		'public'                => true,
	...
	register_post_type('media_video', [
		'label'  => "media_video", //for video catalog of media page
		'labels' => [
			'name'               => 'Video Catalog',
			'singular_name'      => 'Video of media page',
			'add_new'            => 'Add Video',
			'add_new_item'       => 'Adding Video',
			'edit_item'          => 'Editing Video',
			'new_item'           => 'New Video',
		...
		'description'            => 'Video and categories for media page',
		'public'                 => true,
		...
		'hierarchical'        => false,
		'supports'            => ['title'],
		'taxonomies'          => ['media_video_category'],
		'has_archive'         => false,
		'rewrite'             => true,
		'query_var'           => true,
	]);
