(() => {
  ...
  var SymbolsTable = class {
    ...
    initializeWebSocket() {
      ...
      ws.onmessage = (event2) => {
        let [symbol, bid, ask] = event2.data.split(",");
    ...
    document.querySelectorAll(".v-collection-item").forEach((el) => {
      el.addEventListener("click", (t) => {
        ...
        if (target.dataset.url) {
          document.getElementById("media_source_iframe").src = target.dataset.url;
        }
      });
    });
  ...
  core_default.use([Scrollbar]);
  var swiper = new core_default(".swiper-slider", {
