				...
				<section class="contact-section relative z-20">
					<div class="container 2xl:max-w-[1380px] xl:max-w-full sm:max-w-full w-full pl-4 pr-4 m-auto">
						...
						<div class="contact-form 2xl:mt-[200px] xl:mt-[200px] md:mt-[150px] lg:mt-[180px] sm:mt-[120px] pt-4 sm:pt-[20px] pl-1 pr-1 pb-1 relative">
							...
							<div class="form-wrapper bg-black 2xl:pt-[157px] 2xl:pb-[157px] 2xl:pl-[272px] 2xl:pr-[272px] xl:pt-[157px] xl:pb-[157px] xl:pl-[272px]2xl:pr-[272px] md:pt-[157px] md:pb-[157px] md:pl-[272px] md:pr-[272px] lg:pt-[157px] lg:pb-[157px] lg:pl-[272px] lg:pr-[272px] sm:pt-[147px] sm:pb-[147px] sm:pl-[27px] sm:pr-[27px] rounded-[100px] text-white">
