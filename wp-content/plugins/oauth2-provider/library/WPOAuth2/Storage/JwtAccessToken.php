...
class JwtAccessToken implements JwtAccessTokenInterface {
	 ...
	 *                                                                you want to retain access token grant information somewhere, but is not
	 *                                                                necessary when using this grant type.
	...
	public function getAccessToken( $oauth_token ) {
		...
		/*
		* This looked for public storage as if it was incomplete. Let's make it a permanent fix for the time being.
		*/
