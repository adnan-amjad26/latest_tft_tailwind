...
<section class="leaderboard py-[100px] overflow-visible z-20 bricks-elem relative z-[2]" data-scroll-section>
    <div class="max-w-[996px] w-full mx-auto relative z-10">
        ...
        <div class="flex justify-center">
            <div class="w-full">
                <div class="leaderboard-frame font-headers bg-black pb-12 relative rounded-[50px]">
                    <?php if($title): ?>
                        <div class="top w-full row items-center gap-8 py-12 px-12 lg:px-16">
                            <svg decoding="async"><use xlink:href="#crown"></use></svg>
                            <h4 class="text-[30px]"><?php echo $title; ?></h4>
                        </div>
                    <?php endif; ?>
                    <div class="flex flex-col gap-[30px] p-[20px_65px] relative z-[10]">
                        <div class="flex justify-between items-center text-[20px] wadik text-white gap-[25px]">
                            <h4>1ST</h4>
